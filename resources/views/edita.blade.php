    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="../atualiza/{{ $pizza['id'] }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-2 mb-3">
                        <div class="form-floating col-md">
                            <input type="sabor" class="form-control" name="sabor" id="floatingInput"
                                value="{{ $pizza['sabor'] }}" placeholder="Portuguesa">
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" name="descricao" placeholder="Breve explicação dos ingredientes da pizza"
                            id="floatingTextarea">{{ $pizza['descricao'] }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col mx-auto text-center">
                            <img id="frame" src='{{ asset("storage/{$pizza->imagem}") }}' class="img-fluid mt-3"/>
                        </div>
                    </div>
